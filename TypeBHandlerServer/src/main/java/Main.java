...
public class Main {
    private final static String TOPIC = "TYPE-B-HANDLER-TOPIC";
    ...
    private static void handleNewMessage(NewMessage newMessage){
        ...
        newMessage.getMessageDetails().setParsed("Type B parser");
        newMessage.getMessageDetails().setServiceId("Type B service");
